function [robin_graph,robin_xyz,n_ar] = robins_3d(n_g2m,nx,ny,nz,graph2mesh,mesh2graph,neigh_type)
% diego domenzain
% ? 2021
% ------------------------------------------------------------------------------
...
% n_ar       : indexed by nodes in the mesh 🎲. of size nprobin_ × 1.
%              this one doesnt have repetitions. counts
%              how many entries are repeated in robin_mesh.
% robin_graph: robin nodes in the graph 🍇. of size nprobin × 2:
...
% ------------------------------------------------------------------------------
% translate to coordinates in the graph 🍇
