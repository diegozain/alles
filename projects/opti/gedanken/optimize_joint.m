...
% ..............................................................................
[u_w_o,d_w_o]   = fwd_w(p_w_o,s_w,Mw,zeros(nd_w,1));
...
% ..............................................................................
Nreg = eye(length(p_w_o));
% ..............................................................................
EE = E_E_surface(p1,p2,s_w,Mw,d_w_o,Nw,s_dc,Mdc,d_dc_o,Ndc);
% ..............................................................................
% check
%
E1_ = min(EE');
...
% ..............................................................................
max_iter = 100;
[p,P,E,ss] = gd_joint(p,s_w,Mw,d_w_o,Nw,s_dc,Mdc,d_dc_o,Ndc,max_iter);
% ..............................................................................
fprintf('p optimized \n')
fprintf('%d \n',p)
fprintf('\n')
...
plot(p_w_o(2),p_w_o(1),'pr','Markersize',30,'MarkerFaceColor','red')
...
ylabel('Parameter 2')
xlabel('Parameter 1')
title('Joint objective function')
simple_figure()
% ------------------------------------------------------------------------------
% fig = gcf;fig.PaperPositionMode = 'auto'; print(gcf,'optim-wdc','-dpng','-r600')
% ------------------------------------------------------------------------------
% ..............................................................................
%{
% ..............................................................................
