...
% ..............................................................................
EE = Ew_surface(p1,p2,s_w,Mw,d_w_o,Nw);
% ..............................................................................
% check
%
E1_ = min(EE');
...
% ..............................................................................
max_iter = 100;
[p,P,E,ss] = gd_w(p,s_w,Mw,d_w_o,Nw,max_iter);
% ..............................................................................
fprintf('p optimized \n')
fprintf('%d \n',p)
fprintf('\n')
...
simple_figure()
% ------------------------------------------------------------------------------
fig = gcf;fig.PaperPositionMode = 'auto'; print(gcf,'optim-w','-dpng','-r600')
% ------------------------------------------------------------------------------
% ..............................................................................
%{
% ..............................................................................
...
plot(p(2),p(1),'.y','Markersize',40)
plot(P(2,1),P(1,1),'.b','Markersize',60)
plot(p_w_o(2),p_w_o(1),'.k','Markersize',30)
hold off
% xlim([1 15])
% ylim([1 15])
