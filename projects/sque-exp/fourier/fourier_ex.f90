program fourier_ex
 ...
 double precision t, to, source, dt, df
 source(t,to)=dsin(pi*t/to)**3
 ...
 print *,'      If you so desire, run visualize.py to see the output of this.'
 print *,' '
 ! -----------------------------------------------------------------------------
